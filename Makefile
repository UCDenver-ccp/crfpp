...
ACLOCAL = ${SHELL} /Users/roederc/work/git/crfpp/crfpp-read-only/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AR = ar
AUTOCONF = ${SHELL} /Users/roederc/work/git/crfpp/crfpp-read-only/missing --run autoconf
AUTOHEADER = ${SHELL} /Users/roederc/work/git/crfpp/crfpp-read-only/missing --run autoheader
AUTOMAKE = ${SHELL} /Users/roederc/work/git/crfpp/crfpp-read-only/missing --run automake-1.11
AWK = awk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /Users/roederc/work/git/crfpp/crfpp-read-only/missing --run makeinfo
MANIFEST_TOOL = :
...
STRIP = strip
VERSION = 0.58
abs_builddir = /Users/roederc/work/git/crfpp/crfpp-read-only
abs_srcdir = /Users/roederc/work/git/crfpp/crfpp-read-only
abs_top_builddir = /Users/roederc/work/git/crfpp/crfpp-read-only
abs_top_srcdir = /Users/roederc/work/git/crfpp/crfpp-read-only
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /Users/roederc/work/git/crfpp/crfpp-read-only/install-sh
